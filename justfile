...
# field `service_registry`". The v4 line uses `release/0.13` instead — see BLOKLI_REF in
# scripts/integration/run.sh (override: `just blokli_ref=… build-chain`, or set BLOKLI_REF).
